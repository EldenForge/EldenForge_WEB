<script lang="ts">
	...
	function spellBadges(s: Incantation): string[] {
		const out: string[] = [];
...
<svelte:head><title>Incantations — Codex — Elden Forge</title></svelte:head>

<div class="max-w-6xl mx-auto px-4 py-8">
	<CodexHeader title="INCANTATIONS" subtitle="Incantations" />
	...
	{:else if filtered.length === 0}
		<p class="text-center text-parchment/40 italic py-12">No incantation matches your search.</p>
	{:else}
